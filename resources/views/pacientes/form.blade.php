                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="sexo" class="form-control" value="@if(isset($paciente)){{$paciente->sexo}}@else{{old('sexo')}}@endif">
                                                    ...
                                                    <div class="tab-pane" id="outras" role="tabpanel">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4">
                                                                ...
                                                                <select name="civil" class="form-control" value="@if(isset($paciente)){{$paciente->civil}}@else{{old('civil')}}@endif">
                                                                    <option value="">Selecione</option>
